...
#1
df = pd.read_excel("../data/pe/半导体/average_pe_method.xlsx",engine='openpyxl')
#2
df.to_excel("../output/pe/semiconductor_pe_original_data.xlsx")
...
#3
ax.set_ylabel(u"Semiconductor PE",fontsize=8)
...
#4
fig.savefig('../output/pe/semiconductor_raw.png', dpi=300, bbox_inches='tight', pad_inches=1)
#5
img = Image.open('../output/pe/semiconductor_raw.png', 'r')
...
#6
background.save('../output/pe/semiconductor.png')
print("Semiconductor industry data processed.")
plt.show()