...
#%%
df = pd.read_excel("data/pe/白酒/average_pe_method.xlsx",engine='openpyxl')
df.to_excel("output/pe/white_spirt_pe_original_data.xlsx")
df = df.iloc[:,:5]
...
ax.set_ylabel(u"White Sprit PE",fontsize=8)
...
fig.savefig('output/pe/white_sprit_raw.png', dpi=300, bbox_inches='tight', pad_inches=1)

img = Image.open( 'output/pe/white_sprit_raw.png', 'r')
